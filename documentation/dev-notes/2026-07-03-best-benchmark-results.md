...
| Remote-free mixed-size queued-byte policy | `remote_free_mixed_size_trace_capacity256_batch64_max_wait2`: 35.922 us to 36.978 us vs end-drain 39.543 us to 39.945 us, with peak queued bytes reduced from 2,621,440 to 655,360 and `full_count=0` in both policies | `documentation/experiments/0146-remote-free-policy-benchmark-wiring.md` |
