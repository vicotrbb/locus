# Experiment 0089: Mapped Scratch Lock Output Schema

Date: 2026-07-02

## Postulate

See `documentation/postulates/0081-mapped-scratch-lock-output-schema.md`.
...
The postulate survived. The mapped scratch lock probe keeps lock and unlock status lines machine-readable, with free-form error details reserved for separate detail lines when failures occur.
