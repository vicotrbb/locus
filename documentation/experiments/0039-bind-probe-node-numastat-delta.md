# Experiment 0039: Bind Probe Node Numastat Delta

Date: 2026-07-02

## Postulate

See `documentation/postulates/0031-bind-probe-node-numastat-delta.md`.
...
The postulate survived as a compile-time and failure-path check. The bind probe now samples system node `numastat` before and after page touch when available, and the current Docker environment still reports node counter evidence as unavailable.
