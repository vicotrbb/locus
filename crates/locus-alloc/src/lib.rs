...
mod tests {
    ...
    use locus_core::{NodeId, PciDevice, Topology};
    ...
    use super::{
        ...
        MappedScratchAllocError, MappedScratchHugePageAdvice, MappedScratchLockProbeOutput,
        MappedScratchLockProbeOutputParseError, MappedScratchThpAdviceStatus,
        ...
        MappedScratchThpProbeRunStatus, PageLockProbeField, PageLockProbeStatus,
        ...
        PinnedScratchPoolProbeStatsLine, PinnedScratchPoolProbeStatus, MAX_SUPPORTED_ALIGN,
    };
