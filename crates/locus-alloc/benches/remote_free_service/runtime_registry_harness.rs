...
const REGISTRY_BENCHMARK: &str = "remote_free_service_runtime_registry_sequence";
const REGISTRY_SAMPLE: &str = "remote_free_service_runtime_registry_sample";
const REGISTRY_SAMPLE_SUMMARY: &str = "remote_free_service_runtime_registry_sample_summary";
...
pub(crate) fn benchmark_runtime_registry_sequence(c: &mut Criterion) {
    ...
    c.bench_function(REGISTRY_BENCHMARK, |bench| {
        bench.iter(|| {
...
fn print_registry_sample() {
    if !should_print_sample(REGISTRY_SAMPLE, REGISTRY_BENCHMARK) {
        return;
    }
...
fn print_registry_sample_summary() {
    if !should_print_sample(REGISTRY_SAMPLE_SUMMARY, REGISTRY_BENCHMARK) {
        return;
    }
