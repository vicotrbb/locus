...
fn remote_free_service_telemetry(c: &mut Criterion) {
    ...
    remote_free_service_runtime_service_window_harness::benchmark_runtime_dirty_window_collection_sequence(
        c,
    );
    remote_free_service_runtime_service_window_harness::benchmark_runtime_dirty_enqueue_collection_sequence(
        c,
    );
    remote_free_service_runtime_service_window_harness::benchmark_runtime_dirty_local_collection_sequence(
        c,
    );
    remote_free_service_runtime_service_window_harness::benchmark_runtime_dirty_local_reused_collection_sequence(
        c,
    );
    remote_free_service_runtime_service_window_harness::benchmark_runtime_dirty_local_buffer_group_collection_sequence(
        c,
    );
    ...
    remote_free_service_runtime_service_window_harness::benchmark_runtime_dirty_local_buffer_group_validated_collection_sequence(
        c,
    );
    remote_free_service_runtime_service_window_harness::benchmark_runtime_dirty_local_burst_collection_sequence(
        c,
    );
    remote_free_service_runtime_service_window_harness::benchmark_runtime_dirty_local_threshold_collection_sequence(
        c,
    );
}
