...
/// Summarizes saved verifier-summary verification rollup verification JSON records found in a log.
///
/// # Errors
///
/// Returns an error when no verifier JSON records are found, a record cannot
/// be parsed, or aggregate counters overflow.
pub fn summarize_remote_free_service_telemetry_collection_summary_rollup_check_log_summary_verification_rollup_verification_summary_verification_rollup_verification_json_log(
    input: &str,
) -> Result<
    RemoteFreeServiceTelemetryCollectionSummaryRollupCheckLogSummaryVerificationRollupVerificationSummaryVerificationRollup,
    RemoteFreeServiceTelemetryCollectionSummaryRollupError,
>{
    ...
    for line in input.lines().map(str::trim).filter(|line| !line.is_empty()) {
        if line.starts_with('{') {
            ...
            {
                let report =
                    parse_remote_free_service_telemetry_collection_summary_rollup_check_log_summary_verification_rollup_verification_summary_verification_rollup_verification_json_line(line)?;
                add_rollup_check_log_summary_verification_rollup_verification_summary_verification_rollup_verification_to_rollup(
                    &mut rollup,
                    &report,
                )?;
            }
...
/// Verifies an archived repeated-check rollup JSON line against source check records.
///
/// The source log is summarized from saved repeated-check verdict JSON records,
/// then compared with the archived rollup JSON line found in `rollup_input`.
///
/// # Errors
///
/// Returns an error when either input is malformed or any rollup counter
/// differs between the recomputed source-log rollup and the archived rollup.
pub fn verify_remote_free_service_telemetry_collection_summary_rollup_check_log_summary_verification_rollup_verification_summary_verification_rollup_verification_rollup_json_log(
    source_input: &str,
    rollup_input: &str,
) -> Result<
    RemoteFreeServiceTelemetryCollectionSummaryRollupCheckLogSummaryVerificationRollupVerificationSummaryVerificationRollup,
...
/// Builds a verification report for an archived repeated-check rollup JSON line.
///
/// The source log is summarized from saved repeated-check verdict JSON records,
/// then compared with the archived rollup JSON line found in `rollup_input`.
///
...
///
/// Returns an error when either input is malformed.
pub fn check_remote_free_service_telemetry_collection_summary_rollup_check_log_summary_verification_rollup_verification_summary_verification_rollup_verification_rollup_json_log(
    source_input: &str,
    rollup_input: &str,
) -> Result<
    RemoteFreeServiceTelemetryCollectionSummaryRollupCheckLogSummaryVerificationRollupVerificationSummaryVerificationRollupVerification,
...
fn add_rollup_check_log_summary_verification_rollup_verification_summary_verification_rollup_verification_to_rollup(
    rollup: &mut RemoteFreeServiceTelemetryCollectionSummaryRollupCheckLogSummaryVerificationRollupVerificationSummaryVerificationRollup,
    report: &RemoteFreeServiceTelemetryCollectionSummaryRollupCheckLogSummaryVerificationRollupVerificationSummaryVerificationRollupVerification,
) -> Result<(), RemoteFreeServiceTelemetryCollectionSummaryRollupError> {
    let summary = &mut rollup.summary;
...
mod tests {
  ...
  "artifacts": [
    ...
    #[test]
    fn summarizes_rollup_check_log_summary_json_verification_rollup_verdict_summary_verdict_rollup_verification_json(
    ) -> Result<(), Box<dyn std::error::Error>> {
        let source_log =
            sample_rollup_check_log_summary_json_verification_rollup_verdict_summary_verdict_log()?;
        let rollup =
        ...
        let matched_verdict_json =
            format_remote_free_service_telemetry_collection_summary_rollup_check_log_summary_verification_rollup_verification_summary_verification_rollup_verification_json_line(
                &matched_report,
            )?;
        let mut rollup_value = serde_json::from_str::<serde_json::Value>(&matched_rollup_json)?;
        rollup_value["records"] = json!(1);
        let drifted_rollup_json = serde_json::to_string(&rollup_value)?;
        let drifted_report =
            check_remote_free_service_telemetry_collection_summary_rollup_check_log_summary_verification_rollup_verification_summary_verification_rollup_json_log(
        ...
        let drifted_verdict_json =
            format_remote_free_service_telemetry_collection_summary_rollup_check_log_summary_verification_rollup_verification_summary_verification_rollup_verification_json_line(
                &drifted_report,
            )?;
        let log = format!(
            "matched check\n{matched_verdict_json}\ndrifted check\n{drifted_verdict_json}\n"
        );
    ...
    #[test]
    fn parses_rollup_check_log_summary_json_verification_rollup_verdict_summary_verdict_rollup_verification_rollup_json(
    ) -> Result<(), Box<dyn std::error::Error>> {
        let (log, json_line) =
        ...
        let json_log = format!("dashboard rollup\n{json_line}\n");
    ...
    fn sample_rollup_check_log_summary_json_verification_rollup_verdict_summary_verdict_rollup_verification_inputs(
    ) -> Result<(String, String), Box<dyn std::error::Error>> {
        let source_log =
            sample_rollup_check_log_summary_json_verification_rollup_verdict_summary_verdict_log()?;
        let rollup =
        ...
        let log = format!("{matched_verdict_json}\n{drifted_verdict_json}\n");
        let rollup =
            summarize_remote_free_service_telemetry_collection_summary_rollup_check_log_summary_verification_rollup_verification_summary_verification_rollup_verification_json_log(
                &log,
            )?;
    ...
    #[test]
    fn verifies_rollup_check_log_summary_json_verification_rollup_verdict_summary_verdict_rollup_verification_rollup_against_source(
    ) -> Result<(), Box<dyn std::error::Error>> {
    ...
    #[test]
    fn reports_rollup_check_log_summary_json_verification_rollup_verdict_summary_verdict_rollup_verification_rollup_record_drift(
    ) -> Result<(), Box<dyn std::error::Error>> {
        let (source_log, rollup_json) =
            sample_rollup_check_log_summary_json_verification_rollup_verdict_summary_verdict_rollup_verification_inputs(
            )?;
    ...
    #[test]
    fn formats_rollup_check_log_summary_json_verification_rollup_verdict_summary_verdict_rollup_verification_rollup_match_json(
    ) -> Result<(), Box<dyn std::error::Error>> {
        let (source_log, rollup_json) =
            sample_rollup_check_log_summary_json_verification_rollup_verdict_summary_verdict_rollup_verification_inputs(
            )?;
    ...
    #[test]
    fn formats_rollup_check_log_summary_json_verification_rollup_verdict_summary_verdict_rollup_verification_rollup_drift_json(
    ) -> Result<(), Box<dyn std::error::Error>> {
        let (source_log, rollup_json) =
            sample_rollup_check_log_summary_json_verification_rollup_verdict_summary_verdict_rollup_verification_inputs(
            )?;
    ...
    #[test]
    fn parses_rollup_check_log_summary_json_verification_rollup_verdict_summary_verdict_rollup_verification_rollup_match_json(
    ) -> Result<(), Box<dyn std::error::Error>> {
        let (source_log, rollup_json) =
            sample_rollup_check_log_summary_json_verification_rollup_verdict_summary_verdict_rollup_verification_inputs(
            )?;
        ...
        let verdict_log = format!("repeated check verdict\n{verdict_line}\n");
    ...
    #[test]
    fn parses_rollup_check_log_summary_json_verification_rollup_verdict_summary_verdict_rollup_verification_rollup_drift_json(
    ) -> Result<(), Box<dyn std::error::Error>> {
        let (source_log, rollup_json) =
            sample_rollup_check_log_summary_json_verification_rollup_verdict_summary_verdict_rollup_verification_inputs(
            )?;
        ...
        assert_eq!(parsed.expected.summary.records, 2);
        assert_eq!(parsed.actual.summary.records, 1);
        Ok(())
    }

    #[test]
    fn summarizes_rollup_check_log_summary_json_verification_rollup_verdict_summary_verdict_rollup_verification_rollup_verification_json(
    ) -> Result<(), Box<dyn std::error::Error>> {
        let (source_log, rollup_json) =
            sample_rollup_check_log_summary_json_verification_rollup_verdict_summary_verdict_rollup_verification_inputs(
            )?;
        let matched_rollup_log = format!("dashboard rollup\n{rollup_json}\n");
        let matched_report =
            check_remote_free_service_telemetry_collection_summary_rollup_check_log_summary_verification_rollup_verification_summary_verification_rollup_verification_rollup_json_log(
                &source_log,
                &matched_rollup_log,
        ...
        let mut value = serde_json::from_str::<serde_json::Value>(&rollup_json)?;
        value["records"] = json!(1);
        let drifted_rollup_log = serde_json::to_string(&value)?;
        let drifted_report =
            check_remote_free_service_telemetry_collection_summary_rollup_check_log_summary_verification_rollup_verification_summary_verification_rollup_verification_rollup_json_log(
                &source_log,
                &drifted_rollup_log,
    ...
    #[test]
    fn parses_rollup_check_log_summary_json_verification_rollup_verdict_summary_verdict_rollup_verification_rollup_verification_rollup_match_json(
    ) -> Result<(), Box<dyn std::error::Error>> {
        let (source_log, rollup_json) =
            sample_rollup_check_log_summary_json_verification_rollup_verdict_summary_verdict_rollup_verification_inputs(
            )?;
        ...
        let verdict_log = format!("repeated verdict rollup check\n{verdict_line}\n");
    ...
    #[test]
    fn parses_rollup_check_log_summary_json_verification_rollup_verdict_summary_verdict_rollup_verification_rollup_verification_rollup_drift_json(
    ) -> Result<(), Box<dyn std::error::Error>> {
        let (source_log, rollup_json) =
            sample_rollup_check_log_summary_json_verification_rollup_verdict_summary_verdict_rollup_verification_inputs(
            )?;
    ...
    fn rejects_rollup_check_log_summary_json_verification_rollup_verdict_summary_verdict_rollup_verification_log_without_records(
        ...
        let error =
            ...
            .expect_err("missing verifier-summary verification rollup verification JSON");
