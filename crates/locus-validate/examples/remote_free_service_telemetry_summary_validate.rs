...
fn run_mode(
    ...
    match mode {
        ...
        "--rollup-check-json-summary-verdict-rollup-verify-against-json" => {
            run_rollup_check_json_summary_verdict_rollup_verify_against_json_mode(program, args)?;
        }
        "--rollup-check-json-summary-verdict-rollup-verify-against-json-verify" => {
            run_rollup_check_json_summary_verdict_rollup_verify_against_json_verify_mode(
                program, args,
            )?;
        }
        _ => {
            return run_rollup_check_json_summary_verdict_rollup_tail_mode(program, mode, args);
        }
    }
    Ok(true)
}

fn run_rollup_check_json_summary_verdict_rollup_tail_mode(
    program: &str,
    mode: &str,
    args: &mut impl Iterator<Item = String>,
) -> Result<bool, Box<dyn std::error::Error>> {
    match mode {
        "--rollup-check-json-summary-verdict-rollup-verify-against-json-summary" => {
            run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_mode(
                program, args,
            )?;
        }
        "--rollup-check-json-summary-verdict-rollup-verify-against-json-summary-verify" => {
            run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_mode(
                program, args,
            )?;
        }
        "--rollup-check-json-summary-verdict-rollup-verify-against-json-summary-verify-against" => {
            run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_mode(
                program, args,
            )?;
        }
        "--rollup-check-json-summary-verdict-rollup-verify-against-json-summary-verify-against-report" => {
            run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_report_mode(
                program, args,
            )?;
        }
        "--rollup-check-json-summary-verdict-rollup-verify-against-json-summary-verify-against-json" => {
            run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_json_mode(
                program, args,
            )?;
        }
        "--rollup-check-json-summary-verdict-rollup-verify-against-json-summary-verify-against-json-verify" => {
            run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_json_verify_mode(
                program, args,
            )?;
        }
        "--rollup-check-json-summary-verdict-rollup-verify-against-json-summary-verify-against-json-rollup" => {
            run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_json_rollup_mode(
                program, args,
            )?;
        }
        ...
        "--rollup-check-json-summary-verdict-rollup-verify-against-json-summary-verify-against-json-rollup-verify-against-json" => {
            run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_json_rollup_verify_against_json_mode(
                program, args,
            )?;
        }
        "--rollup-check-json-summary-verdict-rollup-verify-against-json-summary-verify-against-json-rollup-verify-against-json-verify" => {
            run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_json_rollup_verify_against_json_verify_mode(
                program, args,
            )?;
        }
...
fn run_rollup_check_json_summary_verdict_rollup_repeated_tail_mode(
    ...
    match mode {
        ...
        "--rollup-check-json-summary-verdict-rollup-verify-against-json-summary-verify-against-json-rollup-verify-against-json-rollup-verify-against-report" => {
        ...
        "--rollup-check-json-summary-verdict-rollup-verify-against-json-summary-verify-against-json-rollup-verify-against-json-rollup-verify-against-json" => {
        ...
        "--rollup-check-json-summary-verdict-rollup-verify-against-json-summary-verify-against-json-rollup-verify-against-json-rollup-verify-against-json-verify" => {
            run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_json_rollup_verify_against_json_rollup_verify_against_json_verify_mode(
                program, args,
            )?;
        }
        ...
        "--rollup-check-json-summary-verdict-rollup-verify-against-json-summary-verify-against-json-rollup-verify-against-json-rollup-verify-against-json-rollup-verify-against-json-verify" => {
            run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_json_rollup_verify_against_json_rollup_verify_against_json_rollup_verify_against_json_verify_mode(
                program, args,
            )?;
        }
        _ => return Ok(false),
...
fn run_rollup_check_json_summary_verdict_rollup_verify_against_json_mode(
    program: &str,
    args: &mut impl Iterator<Item = String>,
) -> Result<(), Box<dyn std::error::Error>> {
    let (source_log_path, rollup_log_path) = two_args(program, args)?;
...
fn run_rollup_check_json_summary_verdict_rollup_verify_against_json_verify_mode(
    program: &str,
    args: &mut impl Iterator<Item = String>,
) -> Result<(), Box<dyn std::error::Error>> {
    let log_path = one_arg(program, args)?;
...
fn run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_mode(
    program: &str,
    args: &mut impl Iterator<Item = String>,
) -> Result<(), Box<dyn std::error::Error>> {
    let log_path = one_arg(program, args)?;
...
fn run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_mode(
    program: &str,
    args: &mut impl Iterator<Item = String>,
) -> Result<(), Box<dyn std::error::Error>> {
    let log_path = one_arg(program, args)?;
...
fn run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_mode(
    program: &str,
    args: &mut impl Iterator<Item = String>,
) -> Result<(), Box<dyn std::error::Error>> {
    let (source_log_path, summary_log_path) = two_args(program, args)?;
...
fn run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_report_mode(
    program: &str,
    args: &mut impl Iterator<Item = String>,
) -> Result<(), Box<dyn std::error::Error>> {
    let (source_log_path, summary_log_path) = two_args(program, args)?;
...
fn run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_json_mode(
    program: &str,
    args: &mut impl Iterator<Item = String>,
) -> Result<(), Box<dyn std::error::Error>> {
    let (source_log_path, summary_log_path) = two_args(program, args)?;
...
fn run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_json_verify_mode(
    program: &str,
    args: &mut impl Iterator<Item = String>,
) -> Result<(), Box<dyn std::error::Error>> {
    let log_path = one_arg(program, args)?;
...
fn run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_json_rollup_mode(
    program: &str,
    args: &mut impl Iterator<Item = String>,
) -> Result<(), Box<dyn std::error::Error>> {
    let log_path = one_arg(program, args)?;
...
fn run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_json_rollup_verify_mode(
    program: &str,
    args: &mut impl Iterator<Item = String>,
) -> Result<(), Box<dyn std::error::Error>> {
    let log_path = one_arg(program, args)?;
...
fn run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_json_rollup_verify_against_json_mode(
    program: &str,
    args: &mut impl Iterator<Item = String>,
) -> Result<(), Box<dyn std::error::Error>> {
    let (source_log_path, rollup_log_path) = two_args(program, args)?;
...
fn run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_json_rollup_verify_against_json_verify_mode(
    program: &str,
    args: &mut impl Iterator<Item = String>,
) -> Result<(), Box<dyn std::error::Error>> {
    let log_path = one_arg(program, args)?;
...
fn run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_json_rollup_verify_against_json_rollup_mode(
    program: &str,
    args: &mut impl Iterator<Item = String>,
) -> Result<(), Box<dyn std::error::Error>> {
    let log_path = one_arg(program, args)?;
...
fn run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_json_rollup_verify_against_json_rollup_verify_against_mode(
    program: &str,
    args: &mut impl Iterator<Item = String>,
) -> Result<(), Box<dyn std::error::Error>> {
    let (source_log_path, rollup_log_path) = two_args(program, args)?;
...
fn run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_json_rollup_verify_against_json_rollup_verify_against_report_mode(
    program: &str,
    args: &mut impl Iterator<Item = String>,
) -> Result<(), Box<dyn std::error::Error>> {
    let (source_log_path, rollup_log_path) = two_args(program, args)?;
...
fn run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_json_rollup_verify_against_json_rollup_verify_against_json_mode(
    program: &str,
    args: &mut impl Iterator<Item = String>,
) -> Result<(), Box<dyn std::error::Error>> {
    let (source_log_path, rollup_log_path) = two_args(program, args)?;
...
fn run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_json_rollup_verify_against_json_rollup_verify_against_json_verify_mode(
    program: &str,
    args: &mut impl Iterator<Item = String>,
) -> Result<(), Box<dyn std::error::Error>> {
    run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_json_rollup_verify_against_json_verify_mode(
...
fn run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_json_rollup_verify_against_json_rollup_verify_against_json_rollup_verify_mode(
    program: &str,
    args: &mut impl Iterator<Item = String>,
) -> Result<(), Box<dyn std::error::Error>> {
    run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_json_rollup_verify_mode(
...
fn run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_json_rollup_verify_against_json_rollup_verify_against_json_rollup_verify_against_json_verify_mode(
    program: &str,
    args: &mut impl Iterator<Item = String>,
) -> Result<(), Box<dyn std::error::Error>> {
    run_rollup_check_json_summary_verdict_rollup_verify_against_json_summary_verify_against_json_rollup_verify_against_json_verify_mode(
...
fn usage_error(program: &str) -> io::Error {
    let usage = [
        ...
        format!("       {program} --dir <evidence-root> [--write-rollup]"),
        format!("       {program} --rollup <collection-summary-rollup.json>"),
        format!("       {program} --rollup-check-json <saved-log.txt>"),
        format!("       {program} --rollup-check-json-summary <saved-log.txt>"),
        format!("       {program} --rollup-check-json-summary-verify <saved-log.txt>"),
        format!(
        ...
        format!("       {program} --rollup-check-json-summary-verdict-rollup <saved-verdict-log.txt>"),
        format!(
        ...
        format!(
            "       {program} --rollup-check-json-summary-verdict-rollup-verify-against-json <saved-verdict-log.txt> <saved-verdict-rollup-log.txt>"
        ),
        format!(
            "       {program} --rollup-check-json-summary-verdict-rollup-verify-against-json-verify <saved-verdict-rollup-verification-log.txt>"
        ),
        format!(
            "       {program} --rollup-check-json-summary-verdict-rollup-verify-against-json-summary <saved-verdict-rollup-verification-log.txt>"
        ),
        format!(
            "       {program} --rollup-check-json-summary-verdict-rollup-verify-against-json-summary-verify <saved-verdict-rollup-verification-summary-log.txt>"
        ),
        format!(
            "       {program} --rollup-check-json-summary-verdict-rollup-verify-against-json-summary-verify-against <saved-verdict-rollup-verification-log.txt> <saved-verdict-rollup-verification-summary-log.txt>"
        ),
        format!(
            "       {program} --rollup-check-json-summary-verdict-rollup-verify-against-json-summary-verify-against-report <saved-verdict-rollup-verification-log.txt> <saved-verdict-rollup-verification-summary-log.txt>"
        ),
        format!(
            "       {program} --rollup-check-json-summary-verdict-rollup-verify-against-json-summary-verify-against-json <saved-verdict-rollup-verification-log.txt> <saved-verdict-rollup-verification-summary-log.txt>"
        ),
        format!(
            "       {program} --rollup-check-json-summary-verdict-rollup-verify-against-json-summary-verify-against-json-verify <saved-verifier-summary-verification-log.txt>"
        ),
        format!(
            "       {program} --rollup-check-json-summary-verdict-rollup-verify-against-json-summary-verify-against-json-rollup <saved-verifier-summary-verification-log.txt>"
        ),
        format!(
        ...
        format!(
            "       {program} --rollup-check-json-summary-verdict-rollup-verify-against-json-summary-verify-against-json-rollup-verify-against-json <saved-verifier-summary-verification-log.txt> <saved-verifier-summary-verification-rollup-log.txt>"
        ),
        format!(
            "       {program} --rollup-check-json-summary-verdict-rollup-verify-against-json-summary-verify-against-json-rollup-verify-against-json-verify <saved-verifier-summary-verification-rollup-verification-log.txt>"
        ),
        format!(
            "       {program} --rollup-check-json-summary-verdict-rollup-verify-against-json-summary-verify-against-json-rollup-verify-against-json-rollup <saved-verifier-summary-verification-rollup-verification-log.txt>"
        ),
        format!(
            "       {program} --rollup-check-json-summary-verdict-rollup-verify-against-json-summary-verify-against-json-rollup-verify-against-json-rollup-verify-against <saved-verifier-summary-verification-rollup-verification-log.txt> <saved-verifier-summary-verification-rollup-log.txt>"
        ),
        format!(
            "       {program} --rollup-check-json-summary-verdict-rollup-verify-against-json-summary-verify-against-json-rollup-verify-against-json-rollup-verify-against-report <saved-verifier-summary-verification-rollup-verification-log.txt> <saved-verifier-summary-verification-rollup-log.txt>"
        ),
        format!(
            "       {program} --rollup-check-json-summary-verdict-rollup-verify-against-json-summary-verify-against-json-rollup-verify-against-json-rollup-verify-against-json <saved-verifier-summary-verification-rollup-verification-log.txt> <saved-verifier-summary-verification-rollup-log.txt>"
        ),
        format!(
        ...
        format!(
            "       {program} --rollup-check-json-summary-verdict-rollup-verify-against-json-summary-verify-against-json-rollup-verify-against-json-rollup-verify-against-json-rollup-verify-against-json-verify <saved-verifier-summary-verification-rollup-verification-log.txt>"
        ),
    ]
    .join("\n");
